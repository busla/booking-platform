...
Note: OAuth2 callback completion is handled by the frontend via
@aws-sdk/client-bedrock-agentcore's CompleteResourceTokenAuthCommand.
The backend API only provides session status checks and token refresh.
"""
